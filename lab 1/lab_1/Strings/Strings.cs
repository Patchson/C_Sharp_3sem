...
namespace Strings
{
    class Strings
    {
        ...
        static void First()
        {
            char[] a1 = { 'w', 'o', 'r', 'd' }; //массив символов
            string string1 = new string(a1); //переформатирование в string
        ...
        static void Second()
        {
            ...
            string[] values = new string[] { s5, s6, s7, s8, s9 }; //массив строк

            String s10 = String.Join(" ", values); //объединение через пробел
            ...
            //Интерполяция - форматирование строки - способ соединения строк через вставку значений
            //переменных в строку-шаблон с помощью фигурных скобок.
